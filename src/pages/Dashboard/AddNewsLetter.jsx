...
export default function AddNewsLetter() {
  ...
  const { direction, getAllNewsLetter } = useUser();
    ...
    let schema = Joi.object({
      ...
      title_ar: Joi.string()
        ...
        .messages({
          "string.empty": `${
            direction === "EN"
              ? "newsletter name Arabic is required"
              : " اسم الخبر باللغة العربية مطلوب"
          }`,
      ...
      title_en: Joi.string()
        ...
        .messages({
          "string.empty": `${
            direction === "EN"
              ? "NewsLetter name English is required"
              : " اسم الخبر باللغة الانجليزية مطلوب"
          }`,
      ...
      description_ar: Joi.string()
        ...
        .messages({
          "string.empty": `${
            direction === "EN"
              ? "newsletter description Arabic is required"
              : "    وصف الخبر باللغة العربية مطلوب"
          }`,
      ...
      description_en: Joi.string()
        ...
        .messages({
          "string.empty": `${
            direction === "EN"
              ? "newsLetter description English is required"
              : "    وصف الخبر باللغة الانجليزية مطلوب"
          }`,
    ...
    let responseValidateServices = validationRegister();
      ...
      formData.append("image", imageChange);
        ...
        const response = await fetch(
          "https://kog.pythonanywhere.com/api/v1/home/newsletters/",
          {
            method: "POST",
            headers: {
      ...
      <form className={style.AddServices} encType="multipart/form-data">
        ...
        <div className={style.headAddServices}>
          <button className="btn btn-secondary" onClick={handleSubmit}>
            {loadingServices ? (
              ...
              <> {direction === "EN" ? "Add NewsLetter" : "اضافة اخبار "}</>
            )}
          </button>
          <button
        ...
        <div className={style.inp}>
          <label htmlFor="title_ar">
            {" "}
            {direction === "EN"
              ? "name NewsLetter Arabic"
              : "اسم الخبر باللغة العربية"}
          </label>
          <br />
          <input
            type="text"
        ...
        <div className={style.inp}>
          <label htmlFor="title_en">
            {direction === "EN"
              ? "name NewsLetter English"
              : "اسم الخبر باللغة الانجليزية"}{" "}
          </label>
          <br />
          <input
            type="text"
        ...
        <div className={style.inptextarea}>
          <label htmlFor="description_ar">
            {direction === "EN"
              ? "description NewsLetter Arabic"
              : "وصف الخبر باللغة العربية"}{" "}
          </label>
          <br />
          <textarea
            name="description_ar"
        ...
        <div className={style.inptextarea}>
          <label htmlFor="description_en">
            {direction === "EN"
              ? "description NewsLetter English"
              : "وصف الخبر باللغة الانجليزية"}{" "}
          </label>
          <br />
          <textarea
            name="description_en"
